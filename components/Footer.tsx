  ...
  return (
    ...
    border border-t-zinc-400 lg:px-55">
      <div className="flex items-center justify-between ">
        ...
        <li className="hover:text-mauve-500 transition-colors duration-300">
           <Link href="/">Home</Link>
        </li>
        <li className="hover:text-mauve-500 transition-colors duration-300">
      ...
      <div className="flex gap-x-6 cursor-pointer">
       ...
       <FaGithub className="text-[32px] text-zinc-800 hover:text-mauve-500 transition-colors duration-300"/>
       </a>
        <a href="https://www.linkedin.com/in/juan-pablo-andrujovich-921386189/" target="_blank">
          <FaLinkedin className="text-[32px] text-zinc-800 hover:text-mauve-500 transition-colors duration-300"/>
        </a>
      </div>
      </div>
